<template>
    ...
    <div class="sm:flex sm:items-center sm:justify-between">
        <a href="https://yfiob.org" class="flex items-center mb-4 sm:mb-0">
    ...
    <span class="block text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2022 <a href="https://yfiob.org" class="hover:underline">YFIOB™</a>. All Rights Reserved.
    </span>
</footer>
</template>